...
CREATE TABLE `favorites` (
  ...
  KEY `FAVORITES_FK_documentsId` (`documentId`),
  KEY `FAVORITES_FK_userToken` (`userToken`),
  CONSTRAINT `FAVORITES_FK_documentsId` FOREIGN KEY (`documentId`) REFERENCES `DOCUMENT` (`docKey`),
  CONSTRAINT `FAVORITES_FK_userToken` FOREIGN KEY (`userToken`) REFERENCES `USER` (`token`)
